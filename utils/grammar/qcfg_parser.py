...
Reference: https://github.com/google-research/language/blob/master/language/compgen/csl/qcfg/qcfg_parser.py"""


from utils.grammar import cfg_converter, cfg_parser, cfg_rule, qcfg_rule
...
def can_parse(source, target, rules, max_single_nt_applications=1, verbose=False):
...
if __name__ == "__main__":
    ...
    parses = parse(tokens, rules, _node_fn, _postprocess_cell_fn)
    print(parses)
