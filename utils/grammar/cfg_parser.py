...
Reference: https://github.com/google-research/language/blob/master/language/compgen/csl/cky/cfg_parser.py
"""
                    ...
                    if len(search_state.anchored_nonterminals) < max_num_nts:
                        ...
                        for nt_end, nonterminal in nonterminal_tuples:
                            ...
                            if new_trie_node:
                                ...
                                new_anchored_nonterminals = (
                                    search_state.anchored_nonterminals[:]
                                )
                                ...
                                search_map[nt_end].append(
                                    SearchState(
                                        new_anchored_nonterminals, new_trie_node
                                    )
                                )
